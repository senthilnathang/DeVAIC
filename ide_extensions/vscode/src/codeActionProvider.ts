...
export class CodeActionProvider implements vscode.CodeActionProvider {
    ...
    async provideCodeActions(
        ...
        const devaicDiagnostics = context.diagnostics.filter(
            diagnostic => diagnostic.source === 'DeVAIC Enhanced'
        );
    ...
    private createSecretFix(document: vscode.TextDocument, diagnostic: vscode.Diagnostic): vscode.CodeAction {
    ...
    private createCommandInjectionFix(document: vscode.TextDocument, diagnostic: vscode.Diagnostic): vscode.CodeAction {
    ...
    private createBufferOverflowFix(document: vscode.TextDocument, diagnostic: vscode.Diagnostic): vscode.CodeAction {
    ...
    private createShowDocumentationAction(diagnostic: vscode.Diagnostic): vscode.CodeAction {
