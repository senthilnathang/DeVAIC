...
class HoverProvider {
    async provideHover(document, position, token) {
        ...
        const devaicDiagnostics = diagnostics.filter(diagnostic => diagnostic.source === 'DeVAIC Enhanced' &&
    ...
    getVulnerabilityDetails(code, message) {
    ...
    getRecommendations(code, languageId) {
